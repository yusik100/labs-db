...
Проєкт: База даних музичного сервісу (Music Service)   

---

## 1. Мета роботи
Протестувати спроєктовану базу даних: виконати наповнення таблиць тестовими даними (INSERT), здійснити вибірку інформації (SELECT), оновлення записів (UPDATE) та видалення даних (DELETE). Перевірити роботу обмежень цілісності (Foreign Keys, CASCADE, RESTRICT).
...
![скріни](screenshots/screenshot1.png)
![скріни](screenshots/screenshot2.png)
![скріни](screenshots/screenshot3.png)
![скріни](screenshots/screenshot4.png)
![скріни](screenshots/screenshot5.png)
